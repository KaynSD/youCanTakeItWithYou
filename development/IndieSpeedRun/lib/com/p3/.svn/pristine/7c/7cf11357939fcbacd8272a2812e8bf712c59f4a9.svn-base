package com.p3.audio.soundcontroller.debug 
{
	...
	public class P3SoundDebug extends MovieClip 
	{
		...
		{
			P3SoundController.inst.playMusic(mus_long, { fadeIn:m_stepper_fade_in.value, fadeOut:m_stepper_fade_out.value, volume:m_slider_volume.value, loops:m_stepper_loops.value, delay:1 } );
		}
