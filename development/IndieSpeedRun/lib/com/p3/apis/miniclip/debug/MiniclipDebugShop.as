package com.p3.apis.miniclip.debug 
{
	...
	public class MiniclipDebugShop extends Window 
	{
		...
		override protected function init():void 
		{
			...
			m_btn_export = new PushButton (this, 220, 4, "Export", onClickExport);
			m_btn_export.width = 60;
			m_btn_import = new PushButton (this, 284, 4, "Import", onClickImport);
			m_btn_import.width = 60;
			
			m_list_products = new com.bit101.components.List (this, 0, 30);
			m_lbl_creditBalance = new Label (this, 70, 4, "Credits : ???");
		...
		private function addListeners():void 
		{
			...
			MiniclipHandler.instance.store.addEventListener(MiniclipStoreEvent.PRODUCTS_UPDATE, onProductsUpdate);
