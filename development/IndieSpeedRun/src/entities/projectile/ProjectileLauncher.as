package entities.projectile 
{
	 ...
	 */
	public class ProjectileLauncher extends DynamicEntity
	{
		
		private var _entitySource:Entity;
		private var _entityTarget:DynamicEntity;
		...
		{
			var tx:Number = _entitySource.center_x;
			var ty:Number = _entitySource.center_y;
