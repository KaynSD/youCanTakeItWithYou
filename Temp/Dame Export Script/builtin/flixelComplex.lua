...
if exportOnlyCSV == false then	
	...
	baseFileText = baseFileText..tab2.."public function addSpriteToLayer(obj:FlxSprite, type:Class, layer:FlxGroup, x:Number, y:Number, angle:Number, flipped:Boolean = false, scaleX:Number = 1, scaleY:Number = 1, properties:Array = null, onAddCallback:Function = null):FlxSprite\n"
	baseFileText = baseFileText..tab2.."{\n"
